...
| - nvalue_water | 数値 |||| 100g当たりに含まれている水分 |
| - nvalue_protein | 数値 |||| 100g当たりに含まれているタンパク質 |
| - nvalue_lipid | 数値 |||| 100g当たりに含まれている脂質 |
| - nvalue_carbohydrate | 数値 |||| 100g当たりに含まれている炭水化物 |
| - nvalue_sodium | 数値 |||| 100g当たりに含まれているナトリウム |
| - nvalue_magnesium | 数値 |||| 100g当たりに含まれているマグネシウム |
| - nvalue_cholesterol | 数値 |||| 100g当たりに含まれているコレステロール |
| - nvalue_sugar | 数値 |||| 100g当たりに含まれている単糖当量 |
|||||||
